...
export default function Step3() {
    ...
    const inputClass = "w-full rounded-lg border-gray-300 bg-white text-gray-900 placeholder:text-gray-400 border p-2.5 focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 outline-none transition-all";
        ...
        switch (formData.hiringFor) {
            case "planner":
                return (
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Total Budget ($)</label>
                            <input
                                type="number"
                                name="budget"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Estimated Guest Count</label>
                            <input
                                type="number"
                                name="guestCount"
            ...
            case "performer":
                return (
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Performance Genre</label>
                            <input
                                type="text"
                                name="genre"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Performance Duration</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Sound Check Time</label>
                            <input
                                type="datetime-local"
                                name="soundCheckTime"
            ...
            case "crew":
                return (
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Years of Experience Required</label>
                            <input
                                type="number"
            ...
            default:
                return <p className="text-gray-500">Please select a role in the previous step.</p>;
        }
    };
